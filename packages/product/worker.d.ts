/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker.d.ts` (hash: 7746ba2b1801521cce3d7202c397e828)
...
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		PRODUCT_INGEST_QUEUE: Queue;
		ESIMACCESS_API_KEY: string;
		ESIMGO_API_KEY: string;
		ESIMCARD_API_KEY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ESIMACCESS_API_KEY" | "ESIMGO_API_KEY" | "ESIMCARD_API_KEY">> {}
}
